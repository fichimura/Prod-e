class CoursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course.save
        format.html { redirect_to course_url(@course), notice: "Curso foi criado." }
  ...
  def update
    ...
    respond_to do |format|
      if @course.update(course_params)
        format.html { redirect_to course_url(@course), notice: "Curso atualizado." }
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:titulo, :descricao, :linguagens, :nivel)
    end
end
